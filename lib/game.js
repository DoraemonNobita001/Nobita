...
const cekWaktuFam = (iqbl, _dir) => {
    setInterval(() => {
        ...
        if (position !== null) {
            ...
            iqbl.sendMessage(_dir[position].id, juwu, MessageType.text)
            _dir.splice(position, 1)
        }
    }, 1000)
}
